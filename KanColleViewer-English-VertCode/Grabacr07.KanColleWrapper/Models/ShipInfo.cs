...
namespace Grabacr07.KanColleWrapper.Models
{
	...
	public class ShipInfo : RawDataWrapper<kcsapi_master_ship>, IIdentifiable
	{
		...
		public string Name
		{
            get
            {
                System.IO.StreamReader filereader = new System.IO.StreamReader("lib/ShipListName.txt", System.Text.Encoding.UTF8, true);
                ...
                while (true)
                {
                    ...
                    if (String.IsNullOrEmpty(read_line))
                    {
                        filereader.Close();
                        break;
                    }
                ...
                //if (RawData.api_name == "赤城改") { return string.Format("Akagi-Kai"); }
